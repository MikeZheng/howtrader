...
import howtrader.app.cta_strategy
from howtrader.app.cta_strategy import CtaTemplate, TargetPosTemplate
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        app_path: Path = Path(howtrader.app.cta_strategy.__file__).parent
